...
#Create_model creates the necessary model for training our model here
#Different models tried here are :


def create_model(activation, input_shape=(64, 64)):  #simple
    """
...
def create_model_maxpooling(activation, input_shape=(64, 64)):  #maxpooling
    """ 
...
def create_model_larger(activation, input_shape=(64, 64)):    #larger
    """
...
def create_model_deeper(activation, input_shape=(64, 64)):   #deeper
    """
...
#Training with input and outputs
def training_cnn(m, X, Y, verbose, batch_size=16, epochs=15, data_augm=False):
    """
...
#This function is called from deformable model notebook. This executes all the fuctions related to CNN.
def run(model='simple', X_to_pred=None, history=False, verbose=0, activation=None, epochs=20, data_augm=False):
    ...
    h, m = training_cnn(m, X, Y, verbose=verbose, batch_size=16, epochs=epochs, data_augm=False)
